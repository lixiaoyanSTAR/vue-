  ...
  <div class="detail container">
    ...
    <ul class="list-group">
      <li class="list-group-item">
       ...
       <li class="list-group-item">
        <span class="glyphicon glyphicon-heart">{{customer.email}}</span>
      </li>
    </ul>
     <ul class="list-group">
      <li class="list-group-item">
       ...
       <li class="list-group-item">
        <span class="glyphicon glyphicon-heart">{{customer.graduationschool}}</span>
      </li>
       <li class="list-group-item">
        <span class="glyphicon glyphicon-heart">{{customer.profession}}</span>
      </li>
       <li class="list-group-item">
        <span class="glyphicon glyphicon-heart">{{customer.profile}}</span>
      </li>
    </ul>
  </div>
</template>
